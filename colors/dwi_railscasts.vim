...
let g:colors_name = "dwi_railscasts"
...
hi CursorLine                guibg=#252525 ctermbg=234
hi LineNr                    guifg=#494949 ctermfg=238 guibg=#2f2f2f ctermbg=236 gui=italic
hi Search                    guibg=#5A647E ctermbg=60
hi Visual                    guibg=#000000 ctermbg=0
hi VertSplit				 guibg=#ffffff ctermbg=15 guifg=#ffffff ctermfg=15

hi User1					 guibg=#aa0000 ctermbg=124 guifg=#ffffff ctermfg=15
hi NonText					 guifg=#333333 ctermfg=235 guibg=#2B2B2B ctermbg=235 
hi SpecialKey				 guifg=#333333 ctermfg=235 guibg=#2B2B2B ctermbg=235 
hi StatusLine				 guifg=#333333 ctermfg=236 guibg=#A5C261 ctermbg=143 gui=none
hi StatusLineNC				 guifg=#333333 ctermfg=236 guibg=#ffffff ctermbg=15 gui=none

" Folds
" -----
" line used for closed folds
hi Folded                    guifg=#656565 ctermfg=241 guibg=#333333 ctermbg=236 gui=NONE
...
"rubyComment
hi Comment                   guifg=#6f6a66 ctermfg=242 gui=italic
...
hi MatchParen				 guibg=#85cc31 guifg=#000000
