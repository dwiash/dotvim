...
" Split area
hi StatusLine   gui=NONE guifg=#f8f8f8 guibg=#88CC00
hi StatusLineNC gui=ITALIC guifg=#808080 guibg=#404040
hi VertSplit    gui=NONE guifg=#404040 guibg=#404040
...
hi LineNr       gui=NONE guifg=#99ccff guibg=NONE
hi NonText      gui=BOLD guifg=#ffffff guibg=#ffffff
...
" Syntax group
hi Comment      gui=NONE guifg=#bdbdbd guibg=NONE
...
hi Todo         gui=UNDERLINE guifg=#aaaaaa guibg=#eeeeee
hi Type         gui=NONE guifg=#0070e6 guibg=NONE
hi Underlined   gui=UNDERLINE guifg=fg guibg=NONE


hi User1 guibg=#aa0000 guifg=#ffffff gui=NONE
